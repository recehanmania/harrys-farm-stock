-- Harry's Farm V55 - Final Safety SQL
...
-- V54 tidak menambah tabel baru. Ini hanya final check schema dari V53.

-- V55 tidak butuh tabel baru dari V54/V53.
-- Fitur cegah absen dobel dan PIN Admin berjalan di aplikasi.
-- Pastikan kolom employee_attendance attendance_code/employee_id/shift_name sudah aktif.
notify pgrst, 'reload schema';
